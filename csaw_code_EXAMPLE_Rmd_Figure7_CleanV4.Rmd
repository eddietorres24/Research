...
samples <- read.csv("./Figure7_SampleSheet.csv")

samples$bamReads <- paste("./bamFiles/",samples$bamReads, sep="")
...
#data_K27 <- windowCounts(K27samples$bamReads, spacing=1000, width=1000, shift=0,
#filter=0, bin=TRUE, param=param)
...
K27peaks <- read.table(file="./141-1_ChIP_WT_H3K27me3__peaks.broadPeak")
K9peaks <- read.table(file="./141-115_ChIP_WT_H3K9me3__peaks.broadPeak")
...
#make a gRanges object and a dataframe object for K27 domains
    suppressWarnings(keepK27 <- overlapsAny(rowRanges(data_csaw), K27_Peaks.gr, type="within"))
    summary(keepK27)
