...
####
#Gain in active mods
Kac_prom_gain_CAF = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_cac1 > 0.75 | Kac_Results_K27promTSS_vWT$logFC_cac2 > 0.75)

Kac_prom_gain_cac1 = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_cac1 > 0.75)
Kac_prom_gain_cac2 = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_cac2 > 0.75)

Kac_prom_gain_set7 = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_set7 > 0.75)
Kac_prom_gain_suz12 = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_suz12 > 0.75)

Kac_prom_gain_suz12_noCAF = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$logFC_suz12 > 0.75 & ! Kac_Results_K27promTSS_vWT$gene_id %in% Kac_prom_gain_CAF$gene_id)

Kac_nochange = subset(Kac_Results_K27promTSS_vWT, ! Kac_Results_K27promTSS_vWT$gene_id %in% Kac_prom_gain_CAF$gene_id & ! Kac_Results_K27promTSS_vWT$gene_id %in% Kac_prom_gain_suz12$gene_id)
...
K4_genes_gain_suz12 = subset(H3K4me2_Results_K27genes_vWT, H3K4me2_Results_K27genes_vWT$logFC_suz12 > 0.75)
K4_genes_gain_suz12_noCAF = subset(H3K4me2_Results_K27genes_vWT, H3K4me2_Results_K27genes_vWT$logFC_suz12 > 0.75 & ! H3K4me2_Results_K27genes_vWT$gene_id %in% K4_genes_gain_CAF$gene_id)
K4_nochange = subset(H3K4me2_Results_K27genes_vWT, ! H3K4me2_Results_K27genes_vWT$gene_id %in% K4_genes_gain_CAF$gene_id & ! H3K4me2_Results_K27genes_vWT$gene_id %in% K4_genes_gain_suz12$gene_id)
...
write.table(K4_Gain_CAF1, file = "K4_Gain_CAF1.bed", sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
