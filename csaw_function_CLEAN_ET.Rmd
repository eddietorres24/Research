...
peaks <- heatmap_to_bed_peaks(
  ...
  out_dir       = "csaw_beds/H3K36me3_vInput",
  prefix        = "H3K36me3_enriched_genes",
  mode          = "region",
  direction     = "positive",
  min_value     = 2,                         
...
H3K36me3_set2_meth <- subset(H3K36me3_methylated_genes_log2FC_0.1_WT_genes_BED, ! regions$allgenes$V10 %in% H3K36me3_no_ash1$V10 & ! regions$allgenes$V10 %in% K27_enriched$V10)
