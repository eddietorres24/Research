...
peaks <- heatmap_to_bed_peaks(
  hm_df         = H3K36me3_Heatmap_K27genes_vInput,  # masked heatmap over K27promTSS regions
  out_dir       = "csaw_beds/H3K36me3_vInput",
  prefix        = "H3K36me3_methylated_genes",
  mode          = "region",
  direction     = "positive",
  min_value     = 0.1,                         
  ...
  source_regions_df = regions$K27genes, # needs to match your original region df with coords + gene IDs
