...
# (Recommended) Filter your manual cluster dfs to those same genes
clust1 <- subset(K36lost, K36lost$gene_id %in% genes_keep)
clust2 <- subset(K27lost_only, K27lost_only$gene_id %in% genes_keep)
clust3
clust4
...
out <- make_chip_rna_heatmap_simple(
  ...
  gene_col  = "gene_id",
  manual_clusters = list(
    CAF_Gain = Kac_Gain_CAF ,
    set7_Gain = Kac_Gain_set7_noCAF,
    no_change = Kac_no_change,
    unenriched = Kac_unerich
  ),
