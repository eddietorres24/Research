...
Kac_uneriched = subset(Kac_Results_K27promTSS_vWT, ! Kac_Results_K27promTSS_vWT$gene_id %in% Kac_enriched)
...
write.table(Kac_unerich, file = "Kac_uneriched.bed", sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
