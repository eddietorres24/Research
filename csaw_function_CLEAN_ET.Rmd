...
Kac_enrichedvWT <- Kac_Results_K27promTSS_vInput %>%
...
Kac_enrichedvWT = subset(Kac_Results_K27promTSS_vWT, Kac_Results_K27promTSS_vWT$gene_id %in% Kac_enrichedvWT$gene_id)
