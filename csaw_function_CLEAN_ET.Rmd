...
peaks <- heatmap_to_bed_peaks(
  hm_df         = H3K27me3_CS_Heatmap_K27promTSS_vWT,  # masked heatmap over K27promTSS regions
  out_dir       = "csaw_beds/H3K27me3_vWT",
  prefix        = "H3K27me3_lost_genes",
  mode          = "region",
  direction     = "negative",
  min_value     = 2,                         
...
H3K36me3_set2_meth <- subset(regions$allgenes, ! regions$allgenes$V10 %in% H3K36me3_no_ash1$V10 & ! regions$allgenes$V10 %in% K27_enriched$V10)
