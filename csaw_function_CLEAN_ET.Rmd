...
out <- chip_scatter_flex(
  mode        = "chip_vs_rna",
  chip_df_x   = H3K27me3_CS_Results_K27genes_vWT,   
  strain_x    = "cac1",
  ...
  file_prefix = "K27_vs_RNA_set7_K27_genes_proms_TESTING",
...
out <- chip_scatter_flex(
  ...
  strain_x      = "set7",
  chip_df_y     = Kac_Results_K27genes_proms_vWT,
  strain_y      = "set7",
  ...
  out_dir       = "scatter_outputs",
  file_prefix   = "H3K36me3_vs_Kac_set7_promoters_genes",
  width_in      = 12, height_in = 9, dpi = 600
)
out$gg
...
Kac_Gain_CAF1 = subset(regions$K27genes, regions$K27genes$gene_id %in% Kac_genesprom_gain_CAF$gene_id)
...
Kac_Gain_set7 = subset(regions$K27genes, regions$K27genes$gene_id %in% Kac_genesprom_gain_set7$gene_id)
