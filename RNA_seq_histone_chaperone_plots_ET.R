...
ggsave(filename = "histone_chaperone_boxplot_subset_paper.pdf", plot = box, dpi=600, height= 3, width=4)
...
ggsave(filename = "./histone_chaperone_heatmap_redblue_log2.pdf", plot = heatmap_plot, dpi=600, height=4, width=3)
dev.off()
