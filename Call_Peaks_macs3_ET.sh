...
macs3 callpeak -t "${OUTDIR}/SortedBamFiles/6147_136-1_ChIP_WT_H3K27me3_abcam_Rep2.bam" -c "${OUTDIR}/SortedBamFiles/6147_136-11_ChIP_WT_input.bam" -f BAMPE -n "136-1_ChIP_WT_H3K27me3_abcam_Rep2_TEST_2" --broad -g 41037538 --broad-cutoff 0.05 --outdir "${OUTDIR}/Peaks" --min-length 300 --max-gap 200
