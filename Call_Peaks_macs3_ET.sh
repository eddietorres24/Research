...
#H3K27me3 24 hr
#Rep 1
macs3 callpeak -t "${P137DIR}/137-66_ChIP_WT_H3K27me3_Rep1_S63.bam" -c "${P139DIR}/139-29_ChIP_WT_Input__S29.bam" -f BAMPE -n "WT_0hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_0hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-38_ChIP_qa-suz12_cac-1_0hr_H3K27me3_Rep2_S38.bam" -c "${P148DIR}/148-73_ChIP_suz12_0hr_input__S73.bam" -f BAMPE -n "suz12_0hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/suz12_0hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-67_ChIP_qa-suz12_H3K27me3_Rep1_S64.bam" -c "${P139DIR}/139-30_ChIP_qa-suz12_Input__S30.bam" -f BAMPE -n "qa-suz12_0hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_0hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-69_ChIP_qa-suz12_H3K27me3_Rep1_S66.bam" -c "${P139DIR}/139-32_ChIP_qa-suz12_Input__S32.bam" -f BAMPE -n "qa-suz12_4hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_4hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-71_ChIP_qa-suz12_H3K27me3_Rep1_S68.bam" -c "${P139DIR}/139-34_ChIP_qa-suz12_Input__S34.bam" -f BAMPE -n "qa-suz12_8hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_8hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-73_ChIP_qa-suz12_H3K27me3_Rep1_S70.bam" -c "${P139DIR}/139-36_ChIP_qa-suz12_Input__S36.bam" -f BAMPE -n "qa-suz12_12hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_12hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-74_ChIP_WT_H3K27me3_Rep1_S71.bam" -c "${P139DIR}/139-37_ChIP_WT_Input__S37.bam" -f BAMPE -n "WT_24hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_24hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-39_ChIP_qa-suz12_cac-1_4hr_H3K27me3_Rep1_S39.bam" -c "${P144DIR}/144-69_ChIP_suz12_Input__S69.bam" -f BAMPE -n "suz12_24hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/suz12_24hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P137DIR}/137-75_ChIP_qa-suz12_H3K27me3_Rep1_S72.bam" -c "${P139DIR}/139-38_ChIP_qa-suz12_Input__S38.bam" -f BAMPE -n "qa-suz12_24hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_24hr" --min-length 650 --max-gap 375

#Extra_Rep_2
macs3 callpeak -t "${P144DIR}/144-44_ChIP_WT_0hr_H3K27me3_Rep4_S44.bam" -c "${P144DIR}/144-62_ChIP_WT_Input__S62.bam" -f BAMPE -n "WT_0hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_0hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-48_ChIP_qa-suz12_0hr_H3K27me3_Rep4_S48.bam" -c "${P144DIR}/144-71_ChIP_qa-suz12_Input__S71.bam" -f BAMPE -n "qa-suz12_0hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_0hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-49_ChIP_qa-suz12_4hr_H3K27me3_Rep3_S49.bam" -c "${P144DIR}/144-73_ChIP_qa-suz12_Input__S73.bam" -f BAMPE -n "qa-suz12_4hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_4hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-50_ChIP_qa-suz12_8hr_H3K27me3_Rep3_S50.bam" -c "${P144DIR}/144-79_ChIP_qa-suz12_Input__S79.bam" -f BAMPE -n "qa-suz12_8hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_8hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-51_ChIP_qa-suz12_12hr_H3K27me3_Rep3_S51.bam" -c "${P139DIR}/139-36_ChIP_qa-suz12_Input__S36.bam" -f BAMPE -n "qa-suz12_12hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_12hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-52_ChIP_qa-suz12_24hr_H3K27me3_Rep4_S52.bam" -c "${P144DIR}/144-132_ChIP_qa-suz12_Input__S132.bam" -f BAMPE -n "qa-suz12_24hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_24hr" --min-length 650 --max-gap 375
macs3 callpeak -t "${P144DIR}/144-45_ChIP_WT_24hr_H3K27me3_Rep3_S45.bam" -c "${P139DIR}/139-38_ChIP_qa-suz12_Input__S38.bam" -f BAMPE -n "WT_24hr_H3K27me3_Extra_Rep_2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_24hr" --min-length 650 --max-gap 375

#Rep 2
macs3 callpeak -t "${P146DIR}/146-44_ChIP_WT_H3K27me3_Rep1_S44.bam" -c "${P144DIR}/144-62_ChIP_WT_Input__S62.bam" -f BAMPE -n "WT_0hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_0hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-124_ChIP_suz12_0hr_H3K27me3_Rep1_S143.bam" -c "${P148DIR}/148-73_ChIP_suz12_0hr_input__S73.bam" -f BAMPE -n "suz12_0hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/suz12_0hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-125_ChIP_qa-suz12_0hr_H3K27me3_Rep1_S144.bam" -c "${P144DIR}/144-71_ChIP_qa-suz12_Input__S71.bam" -f BAMPE -n "qa-suz12_0hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_0hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-126_ChIP_qa-suz12_4hr_H3K27me3_Rep1_S145.bam" -c "${P148DIR}/148-75_ChIP_qa-suz12_4hr_input__S75.bam" -f BAMPE -n "qa-suz12_4hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_4hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-127_ChIP_qa-suz12_8hr_H3K27me3_Rep1_S146.bam" -c "${P148DIR}/148-76_ChIP_qa-suz12_8hr_input__S76.bam" -f BAMPE -n "qa-suz12_8hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_8hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-128_ChIP_qa-suz12_12hr_H3K27me3_Rep1_S147.bam" -c "${P148DIR}/148-77_ChIP_qa-suz12_12hr_input__S77.bam" -f BAMPE -n "qa-suz12_12hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_12hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-102_ChIP_WT_H3K27me3_Rep3_S126.bam" -c "${P148DIR}/148-72_ChIP_WT_input__S72.bam" -f BAMPE -n "WT_24hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_24hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P144DIR}/144-47_ChIP_suz12_24hr_H3K27me3_Rep2_S47.bam" -c "${P144DIR}/144-69_ChIP_suz12_Input__S69.bam" -f BAMPE -n "suz12_24hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/suz12_24hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P146DIR}/146-129_ChIP_qa-suz12_24hr_H3K27me3_Rep1_S148.bam" -c "${P148DIR}/148-78_ChIP_qa-suz12_24hr_input__S78.bam" -f BAMPE -n "qa-suz12_24hr_H3K27me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_24hr" --min-length 650 --max-gap 250

#Rep 3 (Sample names shifted)
macs3 callpeak -t "${P148DIR}/148-84_ChIP_qa-suz12_24hr_H3K27me3_Rep2_S84.bam" -c "${P148DIR}/148-91_ChIP_WT_input__S91.bam" -f BAMPE -n "WT_0hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/WT_0hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-79_ChIP_WT_H3K27me3_Rep2_S79.bam" -c "${P148DIR}/148-92_ChIP_qa-suz12_0hr_input__S92.bam" -f BAMPE -n "qa-suz12_0hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_0hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-80_ChIP_qa-suz12_0hr_H3K27me3_Rep2_S80.bam" -c "${P148DIR}/148-93_ChIP_qa-suz12_4hr_input__S93.bam" -f BAMPE -n "qa-suz12_4hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_4hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-81_ChIP_qa-suz12_4hr_H3K27me3_Rep2_S81.bam" -c "${P148DIR}/148-94_ChIP_qa-suz12_8hr_input__S94.bam" -f BAMPE -n "qa-suz12_8hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_8hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-82_ChIP_qa-suz12_8hr_H3K27me3_Rep2_S82.bam" -c "${P148DIR}/148-95_ChIP_qa-suz12_12hr_input__S95.bam" -f BAMPE -n "qa-suz12_12hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_12hr" --min-length 650 --max-gap 250
macs3 callpeak -t "${P148DIR}/148-83_ChIP_qa-suz12_12hr_H3K27me3_Rep2_S83.bam" -c "${P148DIR}/148-96_ChIP_qa-suz12_24hr_input__S96.bam" -f BAMPE -n "qa-suz12_24hr_H3K27me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_24hr" --min-length 650 --max-gap 250

#H3K27me3 96 hr
#Rep 1
macs3 callpeak -t "${P146DIR}/146-39_ChIP_qa-suz12_0hr_H3K27me3_Rep1_S39.bam" -c "${P148DIR}/148-73_ChIP_suz12_0hr_input__S73.bam" -f BAMPE -n "qa-suz12_0hr_H3K27me3_Rep4" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_0hr" --min-length 650 --max-gap 275
macs3 callpeak -t "${P146DIR}/146-40_ChIP_qa-suz12_24hr_H3K27me3_Rep1_S40.bam" -c "${P148DIR}/148-68_ChIP_qa-suz12_24hr_input__S68.bam" -f BAMPE -n "qa-suz12_24hr_H3K27me3_Rep4" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_24hr" --min-length 650 --max-gap 275
macs3 callpeak -t "${P146DIR}/146-41_ChIP_qa-suz12_48hr_H3K27me3_Rep1_S41.bam" -c "${P148DIR}/148-69_ChIP_qa-suz12_48hr_input__S69.bam" -f BAMPE -n "qa-suz12_48hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_48hr" --min-length 650 --max-gap 275
macs3 callpeak -t "${P146DIR}/146-42_ChIP_qa-suz12_72hr_H3K27me3_Rep1_S42.bam" -c "${P148DIR}/148-70_ChIP_qa-suz12_72hr_input__S70.bam" -f BAMPE -n "qa-suz12_72hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_72hr" --min-length 650 --max-gap 275
macs3 callpeak -t "${P146DIR}/146-43_ChIP_qa-suz12_96hr_H3K27me3_Rep1_S43.bam" -c "${P148DIR}/148-71_ChIP_qa-suz12_96hr_input__S71.bam" -f BAMPE -n "qa-suz12_96hr_H3K27me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR1}/qa-suz12_96hr" --min-length 650 --max-gap 275
