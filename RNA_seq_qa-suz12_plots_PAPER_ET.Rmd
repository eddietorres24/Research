...
#save plot
ggsave("./qa-suz12_Ectopic_Gene_expression.pdf", plot=violin, width = 8, height = 8, unit="in",  dpi=400)
...
venn.diagram(
  x = list(genes_early$gene_id, rownames(qa_24hr_K27), rownames(WT_24hr_K27)),
