...
venn.diagram(
  x = list(sanity_genes$V10, rownames(qa_24hr_DOWN), rownames(WT_24hr_DOWN)),
  category.names = c("H3K27me3 Ectopic", "qa_24hr DOWN ", "WT_24hr DOWN"),
...
#Make euler plot
ectopic_gain_fit = euler(c("A" = 148, "B" = 1076, "C" = 128, "A&B" = 25, "A&C" = 1, "B&C" = 595, "A&B&C" = 11))
