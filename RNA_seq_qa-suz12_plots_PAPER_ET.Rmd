...
countdataInteractors <- read.table("../text_files/readcounts_qa_paper_TEST.txt",skip=1, header=TRUE,stringsAsFactors=FALSE, row.names=1, check.names=FALSE, sep="\t")
...
venn.diagram(
  x = list(sanity_genes$V10, rownames(qa_24hr_all_K27_DOWN), rownames(WT_24hr_all_K27_DOWN)),
  category.names = c("H3K27me3 Gained", "qa 24hr DOWN", "WT 24hr DOWN"),
...
qa_WT_24hr_DOWN_fit = euler(c("A" = 200, "B" = 14, "C" = 10, "A&B" = 23, "A&C" = 1, "B&C" = 12, "A&B&C" = 14))
qa_WT_24hr_DOWN_eulerplot <- plot(qa_WT_24hr_DOWN_fit)
ggsave(filename = "K27_GAIN_qa_WT_24hr_DOWN.pdf", plot = qa_WT_24hr_DOWN_eulerplot, width = 4, height = 4, dpi = 600)
