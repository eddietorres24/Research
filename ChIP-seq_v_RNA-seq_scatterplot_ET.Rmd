...
K27_results_cac_bed = subset(genes_df, genes_df$Name %in% K27_results_cac$Name)

#subset results
K27_lost_cac = subset(K27_results_cac, K27_results_cac$log2FC_cac1_vsWT <= -1.5 | K27_results_cac$log2FC_cac2_vsWT <= -1.5 )

K27_gain_cac = subset(K27_results_cac, K27_results_cac$log2FC_cac1_vsWT >= 1.5 | K27_results_cac$log2FC_cac2_vsWT >= 1.5 )

K27_in_cac = subset(K27_results_cac, K27_results_cac$log2FC_cac1_vsWT > -1.5 & K27_results_cac$log2FC_cac1_vsWT < 1.5 )
