...
```{r}
cac1_sig <- subset(cac1, padj < 0.01)
cac2_sig <- subset(cac2, padj < 0.01)
cac3_sig <- subset(cac3, padj < 0.01)
naf1_sig <- subset(naf1, padj < 0.01)
naf2_sig <- subset(naf2, padj < 0.01)
asf1_sig <- subset(asf1, padj < 0.01)
ATRX_sig <- subset(ATRX, padj < 0.01)
set7_sig <- subset(set7, padj < 0.01)
...
write.table(track, file="histchaps_all.igv", sep="\t", row.names = FALSE, quote = FALSE)
```
