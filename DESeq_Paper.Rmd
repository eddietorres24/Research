...
write.csv(as.data.frame(cac1_sig), file = "cac1_1.csv")
write.csv(as.data.frame(cac2_sig), file = "cac2_1.csv")
write.csv(as.data.frame(cac3_sig), file = "cac3_1.csv")
write.csv(as.data.frame(naf1_sig), file = "naf1_1.csv")
write.csv(as.data.frame(naf2_sig), file = "naf2_1.csv")
write.csv(as.data.frame(asf1_sig), file = "asf1_1.csv")
write.csv(as.data.frame(ATRX_sig), file = "ATRX_1.csv")
write.csv(as.data.frame(set7_sig), file = "set7_1.csv")
...
track = combine %>% select("SequenceID", "FeatureStart", "FeatureEnd", "VALUE", "asf1_1.csv", "ATRX_1.csv", "cac1_1.csv", "cac2_1.csv", "cac3_1.csv", "naf1_1.csv", "naf2_1.csv", "set7_1.csv")

write.table(track, file="histchaps_TEST_2.igv", sep="\t", row.names = FALSE, quote = FALSE)
```
