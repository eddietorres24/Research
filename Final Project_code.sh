...
#loading modules
module load SRA-Toolkit/3.0.1-centos_linux64 BWA/0.7.17-GCCcore-11.3.0 SAMtools/1.16.1-GCC-11.3.0 Subread/2.0.6-GCC-11.3.0
...
fastq-dump --split-files --gzip ${OUTDIR}/SRR7690267.sra -O ${OUTDIR}
fastq-dump --split-files --gzip ${OUTDIR}/SRR7690268.sra -O ${OUTDIR}
...
bwa mem -t 6 ${OUTDIR}/NC12_genome.fna ${OUTDIR}/SRR7690267_1.fastq.gz ${OUTDIR}/SRR7690267_2.fastq.gz > ${OUTDIR}/SRR7690267.sam
...
bwa mem -t 6 ${OUTDIR}/NC12_genome.fna ${OUTDIR}/SRR7690268_1.fastq.gz ${OUTDIR}/SRR7690268_2.fastq.gz > ${OUTDIR}/SRR7690268.sam
