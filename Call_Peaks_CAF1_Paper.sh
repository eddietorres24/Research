...
#H3K36me3
#Rep3
macs3 callpeak -t "${P138DIR}/138-62_ChIP_WT_H3K36me3_Rep2_6252_S61.bam" -c "${P138DIR}/138-72_ChIP_WT_input__6252_S71.bam" -f BAMPE -n "WT_H3K36me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P138DIR}/138-63_ChIP_cac-1_H3K36me3_Rep2_6252_S62.bam" -c "${P138DIR}/138-73_ChIP_cac-1_input__6252_S72.bam" -f BAMPE -n "cac-1_H3K36me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P138DIR}/138-64_ChIP_cac-2_H3K36me3_Rep2_6252_S63.bam" -c "${P138DIR}/138-74_ChIP_cac-2_input__6252_S73.bam" -f BAMPE -n "cac-2_H3K36me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P138DIR}/138-65_ChIP_cac-3_H3K36me3_Rep2_6252_S64.bam" -c "${P138DIR}/138-75_ChIP_cac-3_input__6252_S74.bam" -f BAMPE -n "cac-3_H3K36me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P138DIR}/138-66_ChIP_set-7_H3K36me3_Rep2_6252_S65.bam" -c "${P138DIR}/138-76_ChIP_set-7_input__6252_S75.bam" -f BAMPE -n "set-7_H3K36me3_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-77_ChIP_suz12_H3K36me3_Rep3_S77.bam" -c "${P152DIR}/152-114_ChIP_suz12_input__S138.bam" -f BAMPE -n "suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-79_ChIP_cac-1_suz12_H3K36me3_Rep3_S79.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K36" --min-length 650 --max-gap 375
#Rep1
macs3 callpeak -t "${P149DIR}/149-99_ChIP_WT_H3K36me3_Rep3_S123.bam" -c "${P149DIR}/149-134_ChIP_WT_input__S158.bam" -f BAMPE -n "WT_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-100_ChIP_cac-1_H3K36me3_Rep3_S124.bam" -c "${P149DIR}/149-135_ChIP_cac-1_input__S159.bam" -f BAMPE -n "cac-1_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-101_ChIP_cac-2_H3K36me3_Rep3_S125.bam" -c "${P149DIR}/149-136_ChIP_cac-2_input__S160.bam" -f BAMPE -n "cac-2_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-102_ChIP_cac-3_H3K36me3_Rep3_S126.bam" -c "${P149DIR}/149-137_ChIP_cac-3_input__S161.bam" -f BAMPE -n "cac-3_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-103_ChIP_set-7_H3K36me3_Rep3_S127.bam" -c "${P149DIR}/149-138_ChIP_set-7_input__S162.bam" -f BAMPE -n "set-7_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-100_ChIP_suz12_H3K36me3_Rep2_S124.bam" -c "${P152DIR}/152-86_ChIP_suz12_input__S86.bam" -f BAMPE -n "suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-101_ChIP_cac-1_suz12_H3K36me3_Rep2_S125.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K36" --min-length 650 --max-gap 375
#Rep2
macs3 callpeak -t "${P150DIR}/150-93_ChIP_WT_H3K36me3_Rep4_S93.bam" -c "${P149DIR}/149-134_ChIP_WT_input__S158.bam" -f BAMPE -n "WT_H3K36me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-94_ChIP_cac-1_H3K36me3_Rep4_S94.bam" -c "${P149DIR}/149-135_ChIP_cac-1_input__S159.bam" -f BAMPE -n "cac-1_H3K36me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-116_ChIP_cac-2_H3K36me3_Rep4_S131.bam" -c "${P149DIR}/149-136_ChIP_cac-2_input__S160.bam" -f BAMPE -n "cac-2_H3K36me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-131_ChIP_cac-3_H3K36me3_Rep4_S146.bam" -c "${P149DIR}/149-137_ChIP_cac-3_input__S161.bam" -f BAMPE -n "cac-3_H3K36me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-134_ChIP_set-7_H3K36me3_Rep4_S149.bam" -c "${P149DIR}/149-138_ChIP_set-7_input__S162.bam" -f BAMPE -n "set-7_H3K36me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-97_ChIP_suz12_H3K36me3_Rep1_S121.bam" -c "${P152DIR}/152-114_ChIP_suz12_input__S138.bam" -f BAMPE -n "suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K36" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-98_ChIP_cac-1_suz12_H3K36me3_Rep1_S122.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K36me3_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K36" --min-length 650 --max-gap 375
...
## Rep2
macs3 callpeak -t "${P149DIR}/149-104_ChIP_WT_H3K9me3_Rep3_S128.bam" -c "${P149DIR}/149-134_ChIP_WT_input__S158.bam" -f BAMPE -n "WT_H3K9me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_H3K9" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-105_ChIP_cac-1_H3K9me3_Rep3_S129.bam" -c "${P149DIR}/149-135_ChIP_cac-1_input__S159.bam" -f BAMPE -n "cac-1_H3K9me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_H3K9" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-106_ChIP_cac-2_H3K9me3_Rep3_S130.bam" -c "${P149DIR}/149-136_ChIP_cac-2_input__S160.bam" -f BAMPE -n "cac-2_H3K9me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_H3K9" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-107_ChIP_cac-3_H3K9me3_Rep3_S131.bam" -c "${P149DIR}/149-137_ChIP_cac-3_input__S161.bam" -f BAMPE -n "cac-3_H3K9me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_H3K9" --min-length 650 --max-gap 375
macs3 callpeak -t "${P149DIR}/149-108_ChIP_set-7_Input_Rep3_S132.bam" -c "${P149DIR}/149-138_ChIP_set-7_input__S162.bam" -f BAMPE -n "set-7_H3K9me3_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_H3K9" --min-length 650 --max-gap 375
...
macs3 callpeak -t "${P152DIR}/152-106_ChIP_suz12_H3K4me2_Rep2_S130.bam" -c "${P152DIR}/152-86_ChIP_suz12_input__S86.bam" -f BAMPE -n "suz12_H3K4me2_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K4" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-107_ChIP_cac-1_suz12_H3K4me2_Rep2_S131.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K4me2_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K4" --min-length 650 --max-gap 375
#Rep2
...
macs3 callpeak -t "${P152DIR}/152-103_ChIP_suz12_H3K4me2_Rep1_S127.bam" -c "${P152DIR}/152-114_ChIP_suz12_input__S138.bam" -f BAMPE -n "suz12_H3K4me2_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K4" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-104_ChIP_cac-1_suz12_H3K4me2_Rep1_S128.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K4me2_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K4" --min-length 650 --max-gap 375
#Rep3
macs3 callpeak -t "${P152DIR}/152-83_ChIP_suz12_H3K4me2_Rep3_S83.bam" -c "${P152DIR}/152-114_ChIP_suz12_input__S138.bam" -f BAMPE -n "suz12_H3K4me2_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_H3K4" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-85_ChIP_cac-1_suz12_H3K4me2_Rep3_S85.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_H3K4me2_Rep3" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_H3K4" --min-length 650 --max-gap 375


#Kac
#Rep1
macs3 callpeak -t "${P150DIR}/150-135_ChIP_WT_Kac_Rep2_S150.bam" -c "${P149DIR}/149-134_ChIP_WT_input__S158.bam" -f BAMPE -n "WT_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-136_ChIP_cac-1_Kac_Rep2_S151.bam" -c "${P149DIR}/149-135_ChIP_cac-1_input__S159.bam" -f BAMPE -n "cac-1_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-137_ChIP_cac-2_Kac_Rep2_S152.bam" -c "${P149DIR}/149-136_ChIP_cac-2_input__S160.bam" -f BAMPE -n "cac-2_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-138_ChIP_cac-3_Kac_Rep2_S153.bam" -c "${P149DIR}/149-137_ChIP_cac-3_input__S161.bam" -f BAMPE -n "cac-3_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P150DIR}/150-139_ChIP_set-7_Kac_Rep2_S154.bam" -c "${P149DIR}/149-138_ChIP_set-7_input__S162.bam" -f BAMPE -n "set-7_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-74_ChIP_suz12_Kac_Rep1_S74.bam" -c "${P152DIR}/152-86_ChIP_suz12_input__S86.bam" -f BAMPE -n "suz12_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-76_ChIP_cac-1_suz12_Kac_Rep1_S76.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_HKac" --min-length 650 --max-gap 375
#Rep2
macs3 callpeak -t "${P151DIR}/151-111_ChIP_WT_Kac_Rep3_S134.bam" -c "${P149DIR}/149-134_ChIP_WT_input__S158.bam" -f BAMPE -n "WT_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/WT_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P151DIR}/151-112_ChIP_cac-1_Kac_Rep3_S135.bam" -c "${P149DIR}/149-135_ChIP_cac-1_input__S159.bam" -f BAMPE -n "cac-1_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-1_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P151DIR}/151-113_ChIP_cac-2_Kac_Rep3_S136.bam" -c "${P149DIR}/149-136_ChIP_cac-2_input__S160.bam" -f BAMPE -n "cac-2_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-2_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P151DIR}/151-114_ChIP_cac-3_Kac_Rep3_S137.bam" -c "${P149DIR}/149-137_ChIP_cac-3_input__S161.bam" -f BAMPE -n "cac-3_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac-3_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P151DIR}/151-115_ChIP_set-7_Kac_Rep3_S138.bam" -c "${P149DIR}/149-138_ChIP_set-7_input__S162.bam" -f BAMPE -n "set-7_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/set-7_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-80_ChIP_suz12_Kac_Rep1_S80.bam" -c "${P152DIR}/152-114_ChIP_suz12_input__S138.bam" -f BAMPE -n "suz12_HKac_Rep1" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/suz12_HKac" --min-length 650 --max-gap 375
macs3 callpeak -t "${P152DIR}/152-82_ChIP_cac-1_suz12_Kac_Rep1_S82.bam" -c "${P152DIR}/152-112_ChIP_cac-1_suz12_input__S136.bam" -f BAMPE -n "cac1_suz12_HKac_Rep2" --broad -g 41037538 --broad-cutoff 0.01 --outdir "${OUTDIR3}/cac1_suz12_HKac" --min-length 650 --max-gap 375
