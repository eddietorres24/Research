...
caf_dba_K27_abc_norm.DB1 <- dba.report(caf_dba_K27_abc_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_K27_abc_norm.DB2 <- dba.report(caf_dba_K27_abc_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_K27_abc_norm.DB3 <- dba.report(caf_dba_K27_abc_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_K27_CS_norm.DB1 <- dba.report(caf_dba_K27_CS_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_K27_CS_norm.DB2 <- dba.report(caf_dba_K27_CS_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_K27_CS_norm.DB3 <- dba.report(caf_dba_K27_CS_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_K36_norm.DB1 <- dba.report(caf_dba_K36_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_K36_norm.DB2 <- dba.report(caf_dba_K36_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_K36_norm.DB3 <- dba.report(caf_dba_K36_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_K36_norm.DB4 <- dba.report(caf_dba_K36_norm, method=DBA_DESEQ2, contrast = 4, th=1, bDB = TRUE)
caf_dba_H4K20_norm.DB1 <- dba.report(caf_dba_H4K20_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_H4K20_norm.DB2 <- dba.report(caf_dba_H4K20_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_H4K20_norm.DB3 <- dba.report(caf_dba_H4K20_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_H4K20_norm.DB4 <- dba.report(caf_dba_H4K20_norm, method=DBA_DESEQ2, contrast = 4, th=1, bDB = TRUE)
caf_dba_H3K4me2_norm.DB1 <- dba.report(caf_dba_H3K4me2_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_H3K4me2_norm.DB2 <- dba.report(caf_dba_H3K4me2_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_H3K4me2_norm.DB3 <- dba.report(caf_dba_H3K4me2_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_H3K4me2_norm.DB4 <- dba.report(caf_dba_H3K4me2_norm, method=DBA_DESEQ2, contrast = 4, th=1, bDB = TRUE)
caf_dba_ATAC_norm.DB1 <- dba.report(caf_dba_ATAC_norm, method=DBA_DESEQ2, contrast = 1, th=1, bDB = TRUE)
caf_dba_ATAC_norm.DB2 <- dba.report(caf_dba_ATAC_norm, method=DBA_DESEQ2, contrast = 2, th=1, bDB = TRUE)
caf_dba_ATAC_norm.DB3 <- dba.report(caf_dba_ATAC_norm, method=DBA_DESEQ2, contrast = 3, th=1, bDB = TRUE)
caf_dba_ATAC_norm.DB4 <- dba.report(caf_dba_ATAC_norm, method=DBA_DESEQ2, contrast = 4, th=1, bDB = TRUE)
export.bed(caf_dba_K27_abc_norm.DB1$peaks[[1]],"WT_v_cac-1_K27_abc_NOT.bed")
