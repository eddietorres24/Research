...
#call Peaks
findPeaks $TAGDIR/qasuz12_0hr -style histone -region -size 150 -minDist 530 -o auto
findPeaks $TAGDIR/qasuz12_4hr -style histone -region -size 150 -minDist 530 -o auto
findPeaks $TAGDIR/qasuz12_8hr -style histone -region -size 150 -minDist 530 -o auto
findPeaks $TAGDIR/qasuz12_12hr -style histone -region -size 150 -minDist 530 -o auto
findPeaks $TAGDIR/qasuz12_24hr -style histone -region -size 150 -minDist 530 -o auto
