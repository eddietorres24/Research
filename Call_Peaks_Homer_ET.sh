...
#Find Motifs
findMotifsGenome.pl qasuz12_4hr_peaks.bed /scratch/evt82290/Foxy_Ncrassa_merged.fasta $OUTDIR/motifs -size given
findMotifsGenome.pl qasuz12_12hr_peaks.bed /scratch/evt82290/Foxy_Ncrassa_merged.fasta $OUTDIR/motifs -size given
findMotifsGenome.pl qasuz12_8hr_no telo_macs_peaks /scratch/evt82290/Foxy_Ncrassa_merged.fasta $OUTDIR/motifs -size given
