...
early_recover = subset(H3K27me3_Results_K27peaks_vInput, (H3K27me3_Results_K27peaks_vInput$logFC_qa_4hr > 1 | H3K27me3_Results_K27peaks_vInput$logFC_qa_0hr > 1) & H3K27me3_Results_K27peaks_vInput$FDR_qa_4hr < 0.05)

late_recover = H3K27me3_Results_K27peaks_vInput %>%
  filter(if_any(all_of(c(18, 21, 24)), ~ coalesce(.x > 1, FALSE)))
late_recover = subset(late_recover, late_recover$FDR_qa_24hr < 0.05 | late_recover$FDR_qa_12hr < 0.05 | late_recover$FDR_qa_8hr < 0.05)
...
unrecovered <- subset(
  H3K27me3_Results_K27peaks_vInput,
  !(do.call(paste, c(H3K27me3_Results_K27peaks_vInput[keys], sep="\u0001")) %in%
...
make_bed <- function(df, regions_k27) {
  ...
  names(bed) <- c("V1","V2","V3")
  bed[order(bed$V1, bed$V2, bed$V3), ]
}
