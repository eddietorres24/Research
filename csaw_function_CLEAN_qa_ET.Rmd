...
out <- chip_scatter_flex(
  ...
  file_prefix = "K27_vs_RNA_cac1_K27_promTSSext",
...
out <- chip_scatter_flex(
  ...
  chip_x_label = "K27",                      # label in axes/title
  out_dir     = "scatter_outputs",
  file_prefix = "K27_vs_RNA_cac2_K27_promTSSext",
  width_in    = 12, height_in = 9, dpi = 600
)
out$gg
...
out <- chip_scatter_flex(
  ...
  chip_x_label = "K27",                      # label in axes/title
  out_dir     = "scatter_outputs",
  file_prefix = "K27_vs_RNA_cac3_K27_promTSSext",
  width_in    = 12, height_in = 9, dpi = 600
)
out$gg
...
out <- chip_scatter_flex(
  ...
  chip_x_label = "K27",                      # label in axes/title
  out_dir     = "scatter_outputs",
  file_prefix = "K27_vs_RNA_ash1_K27_promTSSext",
  width_in    = 12, height_in = 9, dpi = 600
)
out$gg
...
#Write bed file
write.table(genes_overlapping, file = "ectopic_qa_genes.bed", sep = "\t", quote = FALSE, row.names = FALSE, col.names = FALSE)
