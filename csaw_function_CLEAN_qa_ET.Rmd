...
##read in all genes
allgenes = read.table("../bed_files/all_genes_forR.bed")
...
H3K27me3_GAIN_qa_24hr = subset(H3K27me3_Results_allgenes_promTSSext_vWT_0hr, H3K27me3_Results_allgenes_promTSSext_vWT_0hr$logFC_qa_24hr > 1 &  H3K27me3_Results_allgenes_promTSSext_vWT_0hr$FDR_qa_24hr < 0.05 )
...
ectopic_genes = subset(allgenes, allgenes$V10 %in% ectopics$gene_id)
