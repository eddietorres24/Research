...
K27_FilteredHeatmap_df <- dplyr::select(K27.chip.Filteredres.df_SigOnly,7,10,13,16,19,22,25,28,31,34,37,40,43,46,49,52,55,58)
...
K27_FilteredHeatmap_mat_map <- K27_FilteredHeatmap_mat[,c(1:7,11)]
...
no_recover <- subset(K27_FilteredHeatmap_mat_map, rowSums(K27_FilteredHeatmap_mat_map[, 3:7] <= 0) == 5)

recover_order <-order(rowMeans(recover[, c(1,3)]), decreasing = TRUE)
...
pdf("./H3K27me3_peaks_qa-suz12_TESTing.pdf", height = 9)
# Draw the heatmap
