...
FC_WTvInput.K27.contrast <- makeContrasts(K27vWT=WT.H3K27me3_CS-WT.input, levels=design.matK27)
#analyze data
...
png("./Filtered_Heatmap_cacs_K27_WT_sort.png", width = 800, height = 800)
# Draw the heatmap
...
##set7 versus WT
# FC_set7vWT.K27.contrast <- makeContrasts(K27_set7vWT=set7.H3K27me3-WT.H3K27me3,levels=design.mat)
...
png("Filtered_Heatmap_cacs_v_WT_new_green.png", width = 800, height = 800)
# Draw the heatmap
