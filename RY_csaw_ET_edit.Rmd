...
library(circlize)
col_fun<- colorRamp2(c(-1, 0, quantile(K27_FilteredHeatmap_mat, 0.99)), c("white","lightgreen", "darkgreen"))
...
K27_Filtered_hm <- Heatmap(K27_FilteredHeatmap_mat, col = col_fun, cluster_columns = F, show_row_names = FALSE, show_column_dend = FALSE, show_row_dend = FALSE, row_order = order(as.numeric(gsub("row", "", K27_FilteredHeatmap_mat$logFC_WTvInput_K27me3))) , heatmap_legend_param = list(title = "K27me3"))
png("./Filtered_Heatmap_cacs.png", width = 800, height = 800)
# Draw the heatmap
