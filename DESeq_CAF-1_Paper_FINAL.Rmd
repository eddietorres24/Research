...
set7_UP <- subset(set7_DEG, cac1_DEG$log2FoldChange > 0)
set7_DOWN <- subset(set7_DEG, cac1_DEG$log2FoldChange < 0)

cac1_UP_01 <- subset(cac1_DEG_01, cac1_DEG_01$log2FoldChange > 0)
cac1_DOWN_01 <- subset(cac1_DEG_01, cac1_DEG_01$log2FoldChange < 0)
cac2_UP_01 <- subset(cac2_DEG_01, cac1_DEG_01$log2FoldChange > 0)
cac2_DOWN_01 <- subset(cac2_DEG_01, cac1_DEG_01$log2FoldChange < 0)
cac3_UP_01 <- subset(cac3_DEG_01, cac1_DEG_01$log2FoldChange > 0)
cac3_DOWN_01 <- subset(cac3_DEG_01, cac1_DEG_01$log2FoldChange < 0)
set7_UP_01 <- subset(set7_DEG_01, cac1_DEG_01$log2FoldChange > 0)
set7_DOWN_01 <- subset(set7_DEG_01, cac1_DEG_01$log2FoldChange < 0)
...
write.csv(as.data.frame(cac1or2or3_UP), file = "cac1oror3_UP.csv")
...
write.csv(as.data.frame(cac1or2or3_DOWN), file = "cac1oror3_DOWN.csv")
...
cac1_up_K27 <- subset(cac1_up, cac1_up$VALUE %in% Prc2targets$V1)
cac2_up_K27 <- subset(cac2_up, cac2_up$VALUE %in% Prc2targets$V1)
cac3_up_K27 <- subset(cac3_up, cac3_up$VALUE %in% Prc2targets$V1)
set7_up_K27 <- subset(set7_up, set7_up$VALUE %in% Prc2targets$V1)
cac1_up_nonK27 <- subset(cac1_up, ! (cac1_up$VALUE %in% Prc2targets$V1))
cac2_up_nonK27 <- subset(cac2_up, ! (cac2_up$VALUE %in% Prc2targets$V1))
cac3_up_nonK27 <- subset(cac3_up, ! (cac3_up$VALUE %in% Prc2targets$V1))
set7_up_nonK27 <- subset(set7_up, ! (set7_up$VALUE %in% Prc2targets$V1))
cac1and2_up_K27 <- subset(cac1and2_UP, cac1and2_UP$VALUE %in% Prc2targets$V1)
cac1and2and3_up_K27 <- subset(cac1and2and3_UP, cac1and2and3_UP$VALUE %in% Prc2targets$V1)
cac1and2_up_nonK27 <- subset(cac1and2_UP, ! (cac1and2_UP$VALUE %in% Prc2targets$V1))
cac1and2and3_up_nonK27 <- subset(cac1and2and3_UP, ! (cac1and2and3_UP$VALUE %in% Prc2targets$V1))
