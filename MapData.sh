...
#accession=SRR#
fastqPath="/scratch/evt82290/2024_Run137_ET/Run137_FastQ"
...
bwa mem -M -v 3 -t $THREADS $GENOME ${trimmed}/*_val_1.fq.gz ${trimmed}/*_val_2.fq.gz | samtools view -bhSu - | samtools sort -@ $THREADS -T ${tmp}/${accession} -o "$bam" -
samtools index "$bam"
