...
samples <- read.csv("../DiffBind_CAF-1_K27_ET.csv")

## Load bed files with Gene Ranges
...
## Make QC Report
ChIPQCreport(chipObj, reportName="ChIP_QC_report_CAF-1_mods_Paper", reportFolder="ChIPQCreport")
```
